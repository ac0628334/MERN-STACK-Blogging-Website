    ...
    <>
      <div className="flex flex-col py-12 md:flex-row items-center justify-between">
        ...
        <div className="w-full items-center flex flex-col justify-center px-2 sm:w-1/3 gap-2">
          ...
          <p>
            "Hi, I'm Abhishek — a passionate and self-driven developer who loves turning ideas into real-world solutions through clean and creative code."
          </p>
          <h4 className="text-lg font-normal">Email: chavanabhi0288@gmail.com</h4>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center my-6">
        <div className="flex  gap-2 items-center justify-center">
          ...
          <p>
            Median <span className="font-bold text-xl">Blog</span>{" "}
          </p>
        </div>
        <ul className="flex flex-col sm:flex-row items-center  gap-3">
          <li>Privacy Policy</li>
          <li>Terms and conditions</li>
          <li> copyright @Abhishek</li>
        </ul>
      </div>
    </>
  );
